...
Remember devices: Router → Layer 3 Switch → Layer 2 Hub/Repeater → Layer 1


## Lecture 4 – Application Layer


Protocols: HTTP(80), HTTPS(443), FTP(20/21), DNS(53), DHCP(67/68), SMTP(25), POP3(110), IMAP(143), SSH(22), Telnet(23), SNMP(161).
...
Remember: PDU = Bits Fiber = Long distance, high speed Star topology = Most common
...
- Explain packet flow from browser to server.
- Solve scenario-based troubleshooting questions.
- Compare networking devices and protocols.